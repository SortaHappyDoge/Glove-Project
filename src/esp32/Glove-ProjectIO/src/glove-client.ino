...
const char *default_ssid = "TurkTelekom_TB8DB"; // Default WiFi SSID that will be used if input process is skipped
const char *default_password = "h30A2fvu";    // Default WiFi password that will be used if input process is skipped
...
const int mpu_pins[] = {34, 2, 4, 5, 15, 16, 17, 18, 19, 35};
